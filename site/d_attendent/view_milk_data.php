			...
			<body>
				<?php
				include "sidebar/view_milk_data.php"
				?>
				<?php
				include "header.php"
				?>
					...
					<div class="container d-flex flex-column">
						...
						<body>
							...
							<table id="table_id">
								...
								<tbody>
									<?php
									$query = mysqli_query($con, "select liter,fat,snf,date,user.user_name from milk_collection,user where user.user_id=milk_collection.user_id AND milk_collection.dairy_id='$dairy_id'");
