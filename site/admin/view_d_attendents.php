...
<tbody>
<?php 
	$query = mysqli_query($con,"select * from dairy_owner,user where user.user_id=dairy_owner.user_id");
	$row1 = mysqli_num_rows($query);
  	
	while ($result1 = mysqli_fetch_assoc($query)) {
				echo "
				<tr>
				<td>".$result1['dairy_name']."</td>
				<td>".$result1['dairy_type']."</td>
				<td>".$result1['gst_no']."</td>
				...
				<td>".$result1['state']."</td>
				<td><a href='edit.php ? did=$result1[dairy_id] & uid=$result1[user_id] & dname=$result1[dairy_name] & dtype=$result1[dairy_type] & gst=$result1[gst_no]' <i class='fa fa-pen-to-square me-2'></i></a>
				&nbsp;<a href='delete.php ? did=$result1[dairy_id]'onclick='returncheckdelete()'<i class='fa fa-trash-can me-2'></i></td>
				</tr>
...
tr:nth-of-type(even) { 
 background-color: White;
   ...
   You could also use a data-* attribute and content for this. That way "bloats" the HTML, this way means you need to keep HTML and CSS in sync. Lea Verou has a clever way to handle with text-shadow.
	   */
	   td:nth-of-type(1):before { content: "Dairy Type"; }
	   td:nth-of-type(2):before { content: "GST No"; }
