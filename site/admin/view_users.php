			...
			<table id="emp-table">
				<thead>
					<tr>
						...
						<th col-index=1>User ID</th>
						<th col-index=2>User Name</th>
						<th col-index=3>Mobile no</th>
						<th col-index=4>Email</th>
						<th col-index=5>Village
							<select class="table-filter" onchange="filter_rows()">
								<option value="all"></option>
							</select>
						</th>
						<th col-index=6>Taluka
							<select class="table-filter" onchange="filter_rows()">
								<option value="all"></option>
							</select>
						</th>
						<th col-index=7>District
							<select class="table-filter" onchange="filter_rows()">
								<option value="all"></option>
							</select>
						</th>
						<th col-index=8>State
							<select class="table-filter" onchange="filter_rows()">
								<option value="all"></option>
							</select>
						</th>
				...
				<tbody>
					...
					$data = mysqli_query($con, "select user_id from user where role='Admin'");
			   ...
			   <td>" . $result1['state'] . "</td>
			   <td><a href='edituser.php ? uid=$result1[user_id]' class='button button1'>Edit</a>
			   <a href='deleteuser.php ? uid=$result1[user_id]' onclick='returncheckdelete()' class='button button2'>Delete</a>
			   <a href='view_animals.php ? uid=$result1[user_id]' class='button button3'>View Animal</a></td>
			   </tr>
			   ";
					}
					?>
